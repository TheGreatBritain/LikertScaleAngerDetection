...
class TDLikertScaleSelectorUITests: XCTestCase {
    ...
    func testButtonsExists() {
        ...
        let button1 = cell.buttons["Grinning Face"]
        let button2 = cell.buttons["Smiling Face"]
        let button3 = cell.buttons["Neutral Face"]
        let button4 = cell.buttons["Unamused Face"]
        let button5 = cell.buttons["Rolling Eyes"]
